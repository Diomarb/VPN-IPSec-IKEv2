...
|--------------------------|--------------------------------------------------|
| Interceptación           | AES-256 cifra el tráfico                         |
| Modificación de paquetes | HMAC-SHA-256 verifica integridad                 |
| Replay attacks           | Anti-replay ESP habilitado por defecto           |
| Acceso no autorizado     | PSK + DH 14 + Profile IKEv2                     |
| Dead peer                | DPD (Dead Peer Detection) nativo en IKEv2        |
